...
def seed_users():
    demo = User(
        first_name='Demo', last_name='User', email='demo@aa.io', password='password', profile_pic='https://res.cloudinary.com/dt8q1ngxj/image/upload/v1637106867/Capstone/arlo_cermdd.png')
    jack = User(
