...
def seed_dogs():
    ...
    dog16 = Dog(user_id=9, name="Nala", breed="Pug", description="Nala just wants someone to love her as much as she loves walks.", weight=20, address="9036 Calico Court", city="Hesperia", state="CA", country="USA", latitude=34.414491, longitude=-117.375403)
